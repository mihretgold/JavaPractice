...
public class student_admin {
  ...
  public void insert(int id, String sname, String gender, String email, String phone, String fatherName, String motherName, String address){
    ...
    //     get all student values from database student table
      ...
      public void update(int id, String sname, String gender, String email, String phone, String father, String mother, String address){
         String sql = "update student set name=?,gender=?,email=?,phone=?,father_name=?,mother_name=?,address=?";
